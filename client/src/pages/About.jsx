        ...
        <div className="bg-gray-50">
            <div className="container mx-auto py-16 px-6 lg:px-12">
                ...
                <section className="mb-16 text-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        <div className="transform hover:scale-105 transition-transform duration-300">
                            <img
                                src="https://img.freepik.com/free-photo/portrait-handsome-man_23-2150770959.jpg?uid=R115460107&ga=GA1.1.1632891089.1722874396&semt=ais_hybrid"
                                alt="Team Member 1"
                        ...
                        <div className="transform hover:scale-105 transition-transform duration-300">
                            ...
                            <p className="text-md text-gray-500">Head of Design</p>
                        </div>
                        <div className="transform hover:scale-105 transition-transform duration-300">
                            <img
                                ...
                                className="rounded-full shadow-xl mx-auto w-40 h-40 object-cover"
                            />
                            <h3 className="text-2xl font-semibold text-gray-800 mt-4">Sarah Brown</h3>
                            <p className="text-md text-gray-500">Marketing Director</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="text-center bg-white py-16 rounded-lg shadow-lg">
                    ...
                    <img
                        src="https://img.freepik.com/free-photo/medium-shot-girl-having-fun-outdoors_23-2150725977.jpg?t=st=1725370372~exp=1725373972~hmac=c606b3716a7a694c0a3aa990dc8f0c4884bc4e898a3f15d9ecdf8a0f7cc42bbb&w=996" alt="Our Values"
                        className="rounded-lg shadow-xl transform hover:scale-105 transition-transform duration-300 mx-auto md:w-1/2"
                    />
                </section>
            </div>
