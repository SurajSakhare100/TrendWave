...
const Home = () => {
    ...
    useEffect(() => {
        gsap.to(testimonialBox.current, {
            ...
            duration: 10, // Duration for one full cycle
    ...
    return (
        <div className="container mx-auto">
            ...
            {/* Newsletter Section */}
            <section className="relative py-12 md:py-24 bg-cover bg-center text-white" style={{ backgroundImage: `url('https://img.freepik.com/free-photo/beautiful-brunette-woman-holding-shopping-bags_23-2148359561.jpg')` }}>
